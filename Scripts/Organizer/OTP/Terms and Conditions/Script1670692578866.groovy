...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Sign-up to get the Formi dashboard/T and C (1)'))

//WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Sign-up to get the Formi dashboard/Check_box'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Sign-up to get the Formi dashboard/Check_box'))

WebUI.verifyElementNotClickable(findTestObject('Object Repository/Page_Sign-up to get the Formi dashboard/button_Finish (1)'))

WebUI.scrolloElement()

WebUI.click(findTestObject('Object Repository/Page_Sign-up to get the Formi dashboard/Check_box'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Sign-up to get the Formi dashboard/button_Finish (1)'))

WebUI.click(findTestObject('Object Repository/Page_Sign-up to get the Formi dashboard/button_Finish (1)'))

WebUI.delay(5)

url_dashboard = WebUI.getUrl()

url_dashboardfrompage = 'https://organizer-testing.formi.co.in/dashboard'

if (url_dashboard != url_dashboardfrompage) {
	KeywordUtil.markFailed(((url_dashboard + ' and ') + url_dashboardfrompage) + ' do not match')
}
