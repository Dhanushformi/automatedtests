...
//--1) existing email id -> navigate to login screen

WebUI.setText(findTestObject('Object Repository/Page_Sign-up to get the Formi dashboard/input_Email Address_email'), 'zcctrsobh@karenkey.com')
...
WebUI.click(findTestObject('Object Repository/Page_Weve got your back/div_login'))
