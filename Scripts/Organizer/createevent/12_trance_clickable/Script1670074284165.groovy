...
WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Formi - List Event/div_PSYCHEDELIC  TRANCE'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/div_PSYCHEDELIC  TRANCE'))
