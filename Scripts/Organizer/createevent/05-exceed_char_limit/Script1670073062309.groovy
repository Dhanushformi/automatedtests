...
WebUI.setText(findTestObject('Object Repository/Page_Formi - List Event/input_Event Title_name'), 'qwertyuiopasdgghjhggbfbffbfbfbfbfbfbfbfbbffd21111111111111111111343333333333')

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/div_Name cannot be more than 75 characters'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/div_Name cannot be more than 75 characters'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Formi - List Event/div_Name cannot be more than 75 characters'), 
    0)
