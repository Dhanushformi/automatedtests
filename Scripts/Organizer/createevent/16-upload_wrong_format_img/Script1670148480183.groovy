...
WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/span_Click or drag file'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/section_'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/div__ant-slider-handle ant-tooltip-open'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/button_'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/button_OK'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Formi - List Event/div_Basic InfoPoster, name, artist, date an_6fbc4a'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/div_You can only upload JPGPNG file'))
