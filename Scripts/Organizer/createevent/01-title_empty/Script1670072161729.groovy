...
WebUI.setText(findTestObject('Object Repository/Page_Formi - List Event/input_Event Title_name'), 'abc')

WebUI.setText(findTestObject('Object Repository/Page_Formi - List Event/input_Event Title_name'), '')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Formi - List Event/div_Name is required'), 0)
