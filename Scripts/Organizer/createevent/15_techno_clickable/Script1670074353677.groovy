...
WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Formi - List Event/img'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/img'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/div_TECHNO  HOUSE'))
