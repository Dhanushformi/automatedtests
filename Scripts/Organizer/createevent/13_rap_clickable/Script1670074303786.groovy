...
WebUI.setText(findTestObject('Object Repository/Page_Weve got your back/input_Email Address_email'), 'zcctrobh@karenkey.com')
...
WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Formi - List Event/div_RAP'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/img'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/div_RAP'))
