...
WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Formi - List Event/div_Concerts'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/div_Concerts'))
