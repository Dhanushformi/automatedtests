...
WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Formi - List Event/div_BOLLYWOOD'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Formi - List Event/div_BOLLYWOOD'))
