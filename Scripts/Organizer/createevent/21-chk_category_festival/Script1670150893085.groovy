...
WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/div_Select Category'))

WebUI.rightClick(findTestObject('Object Repository/Page_Formi - List Event/div_CategorySelect CategoryClub ShowConcert_907c32'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/div_Select Category'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Formi - List Event/div_Festival'))

WebUI.click(findTestObject('Object Repository/Page_Formi - List Event/div_Festival'))
